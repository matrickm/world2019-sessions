...
//start second snippet
				...
				var description = ((value.MarCommReviewAbstract != null) ? ((value.MarCommReviewAbstract.length > 5000) ? (value.MarCommReviewAbstract.substring(0, 5000) + "...") : value.MarCommReviewAbstract) : "");
